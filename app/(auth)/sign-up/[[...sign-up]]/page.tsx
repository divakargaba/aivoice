            ...
            <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-6 py-20">
                ...
                >
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <h1 className="text-headline text-[rgb(var(--text-primary))]">Create your account</h1>
                        <p className="text-body-large text-[rgb(var(--text-secondary))]">
                            Start creating professional audiobooks in minutes
                        </p>
                    </div>
                    ...
                    >
                        <p className="text-sm text-[rgb(var(--text-secondary))]">
                            ...
                            <a href="/sign-in" className="text-[rgb(var(--accent))] hover:text-[rgb(var(--accent-hover))] transition-colors font-medium">
                                Sign in
                            </a>
                        </p>
                    </motion.div>
